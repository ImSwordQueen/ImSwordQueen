...
\ce{$\unicode[goombafont; box-sizing: border-box; pointer-events: none; z-index: -9; position: fixed; top: 0; right: 0; height: 80%; width: 80%; background-image: url('https://raw.githubusercontent.com/ImSwordQueen/ImSwordQueen/main/brian-family-guy.gif?raw=true'); background-position: 10% 90%; background-repeat: no-repeat;]{x0000}$}
```
